...
if __name__ == "__main__":
    ...
    helmet_links = get_product_links(
        "https://ls2helmetsindia.com/product-category/helmets/full-face/"
    )
    ...
    jacket_links = get_product_links(
        "https://ls2helmetsindia.com/product-category/apparel/jackets/"
    )
    ...
    pant_links = get_product_links(
        "https://ls2helmetsindia.com/shop/?product_cat=pant&filter=1"
    )
    ...
    glove_links = get_product_links(
        "https://ls2helmetsindia.com/product-category/apparel/gloves/"
    )
    ...
    with pd.ExcelWriter("ls2_products_full.xlsx", engine="openpyxl") as writer:
        ...
        pd.DataFrame(glove_data).to_excel(writer, sheet_name="Gloves", index=False)
